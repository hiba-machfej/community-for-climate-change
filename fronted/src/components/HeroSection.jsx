          ...
          <div className="lg:grid lg:grid-cols-8 lg:gap-8">
            <div className="text-center  md:max-w-2xl px-6 lg:col-span-5 lg:text-left flex flex-col items-center justify-center lg:items-start">
              ...
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                Share climate change initiatives with your community members.
                Whether you want to clean your local beach, or help out after
                wildfires you don't have to do it alone. <br />
                <br />
                Post an event in our platform let other people and share the
                efforts.
              </p>
              <svg
                class="animate-bounce w-8 h-8 text-green-600 mt-12 text-center"
                fill="none"
